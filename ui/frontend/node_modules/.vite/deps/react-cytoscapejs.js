...
var require_react_cytoscape = __commonJS({
  "node_modules/react-cytoscapejs/dist/react-cytoscape.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t(require_react(), require_react_dom(), require_prop_types(), require_cytoscape_cjs()) : "function" == typeof define && define.amd ? define(["react", "react-dom", "prop-types", "cytoscape"], t) : "object" == typeof exports ? exports.ReactCytoscape = t(require_react(), require_react_dom(), require_prop_types(), require_cytoscape_cjs()) : e.ReactCytoscape = t(e.React, e.ReactDOM, e.PropTypes, e.cytoscape);
      ...
      return function(e2) {
        ...
        function n2(o2) {
          ...
          return e2[o2].call(r.exports, r, r.exports, n2), r.l = true, r.exports;
        }
        return n2.m = e2, n2.c = t2, n2.d = function(e3, t3, o2) {
          ...
          if (n2.r(o2), Object.defineProperty(o2, "default", { enumerable: true, value: e3 }), 2 & t3 && "string" != typeof e3) for (var r in e3) n2.d(o2, r, (function(t4) {
            return e3[t4];
          }).bind(null, r));
          return o2;
        }, n2.n = function(e3) {
        ...
        }, r = o2({}), u = function(e3, t3) {
          return null == e3 || null == t3;
        };
        t2.hashDiff = function(e3, t3) {
          return u(e3, t3) || e3.hash() !== t3.hash();
        }, t2.shallowObjDiff = function(e3, t3) {
          if (u(e3, t3) && (null != e3 || null != t3)) return true;
          if (e3 === t3) return false;
          if ((void 0 === e3 ? "undefined" : o2(e3)) !== r || (void 0 === t3 ? "undefined" : o2(t3)) !== r) return e3 !== t3;
          var n3 = Object.keys(e3), i = Object.keys(t3), l = function(n4) {
            return e3[n4] !== t3[n4];
          };
          return n3.length !== i.length || !(!n3.some(l) && !i.some(l));
        };
      }, function(e2, t2, n2) {
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true });
        t2.get = function(e3, t3) {
          return null != e3 ? e3[t3] : null;
        }, t2.toJson = function(e3) {
          return e3;
        ...
        }(), r = s(n2(4)), u = s(n2(5)), i = n2(6), l = n2(8), a = s(n2(9)), c = n2(10);
        function s(e3) {
        ...
        var f = function(e3) {
          function t3(e4) {
            ...
            return n3.displayName = "CytoscapeComponent", n3;
          }
          ...
          }(t3, r.default.Component), o2(t3, null, [{ key: "normalizeElements", value: function(e4) {
            if (null != e4.length) return e4;
            var t4 = e4.nodes, n3 = e4.edges;
            return null == t4 && (t4 = []), null == n3 && (n3 = []), t4.concat(n3);
          } }, { key: "propTypes", get: function() {
            return i.types;
          } }, { key: "defaultProps", get: function() {
            return l.defaults;
          } }]), o2(t3, [{ key: "componentDidMount", value: function() {
            var e4 = u.default.findDOMNode(this), t4 = this.props, n3 = t4.global, o3 = t4.headless, r2 = t4.styleEnabled, i2 = t4.hideEdgesOnViewport, l2 = t4.textureOnViewport, c2 = t4.motionBlur, s2 = t4.motionBlurOpacity, f2 = t4.wheelSensitivity, d = t4.pixelRatio, p = this._cy = new a.default({ container: e4, headless: o3, styleEnabled: r2, hideEdgesOnViewport: i2, textureOnViewport: l2, motionBlur: c2, motionBlurOpacity: s2, wheelSensitivity: f2, pixelRatio: d });
            n3 && (window[n3] = p), this.updateCytoscape(null, this.props);
          } }, { key: "updateCytoscape", value: function(e4, t4) {
            var n3 = this._cy, o3 = t4.diff, r2 = t4.toJson, u2 = t4.get, i2 = t4.forEach;
            n3.batch(function() {
              (0, c.patch)(n3, e4, t4, o3, r2, u2, i2);
            }), null != t4.cy && t4.cy(n3);
          } }, { key: "componentDidUpdate", value: function(e4) {
            this.updateCytoscape(e4, this.props);
          } }, { key: "componentWillUnmount", value: function() {
            this._cy.destroy();
          } }, { key: "render", value: function() {
            var e4 = this.props, t4 = e4.id, n3 = e4.className, o3 = e4.style;
            return r.default.createElement("div", { id: t4, className: n3, style: o3 });
          } }]), t3;
        }();
        t2.default = f;
      }, function(t2, n2) {
        ...
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true }), t2.types = void 0;
        var o2 = function(e3) {
          return e3 && e3.__esModule ? e3 : { default: e3 };
        }(n2(7));
        var r = o2.default.string, u = o2.default.array, i = o2.default.object, l = o2.default.number, a = o2.default.bool, c = o2.default.oneOfType, s = o2.default.any, f = o2.default.func;
        t2.types = { id: r, className: r, style: c([r, i]), elements: c([u, s]), stylesheet: c([u, s]), layout: c([i, s]), pan: c([i, s]), zoom: l, panningEnabled: a, userPanningEnabled: a, minZoom: l, maxZoom: l, zoomingEnabled: a, userZoomingEnabled: a, boxSelectionEnabled: a, autoungrabify: a, autolock: a, autounselectify: a, get: f, toJson: f, diff: f, forEach: f, cy: f, headless: a, styleEnabled: a, hideEdgesOnViewport: a, textureOnViewport: a, motionBlur: a, motionBlurOpacity: l, wheelSensitivity: l, pixelRatio: c([r, i]) };
      }, function(e2, t2) {
        e2.exports = n;
      }, function(e2, t2, n2) {
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true }), t2.defaults = t2.pan = t2.zoom = t2.stylesheet = t2.elements = t2.identity = void 0;
        var o2 = n2(0), r = n2(1), u = (t2.identity = function(e3) {
          return e3;
        }, t2.elements = [{ data: { id: "a", label: "Example node A" } }, { data: { id: "b", label: "Example node B" } }, { data: { id: "e", source: "a", target: "b" } }]), i = t2.stylesheet = [{ selector: "node", style: { label: "data(label)" } }], l = t2.zoom = 1, a = t2.pan = { x: 0, y: 0 };
        t2.defaults = { diff: o2.shallowObjDiff, get: r.get, toJson: r.toJson, forEach: r.forEach, elements: u, stylesheet: i, zoom: l, pan: a };
      }, function(e2, t2) {
        e2.exports = o;
      }, function(e2, t2, n2) {
        "use strict";
        Object.defineProperty(t2, "__esModule", { value: true }), t2.patch = void 0;
        var o2 = n2(1), r = n2(0), u = function(e3, t3, n3, r2) {
          return n3((0, o2.get)(e3, r2), (0, o2.get)(t3, r2));
        }, i = (t2.patch = function(e3, t3, n3, s2, f, d, p) {
          (s2 === r.shallowObjDiff || u(t3, n3, s2, "elements")) && c(e3, (0, o2.get)(t3, "elements"), (0, o2.get)(n3, "elements"), f, d, p, s2), u(t3, n3, s2, "stylesheet") && a(e3, (0, o2.get)(t3, "stylesheet"), (0, o2.get)(n3, "stylesheet"), f), ["zoom", "minZoom", "maxZoom", "zoomingEnabled", "userZoomingEnabled", "pan", "panningEnabled", "userPanningEnabled", "boxSelectionEnabled", "autoungrabify", "autolock", "autounselectify"].forEach(function(r2) {
            u(t3, n3, s2, r2) && i(e3, r2, (0, o2.get)(t3, r2), (0, o2.get)(n3, r2), f);
          }), u(t3, n3, s2, "layout") && l(e3, (0, o2.get)(t3, "layout"), (0, o2.get)(n3, "layout"), f);
        }, function(e3, t3, n3, o3, r2) {
          e3[t3](r2(o3));
        }), l = function(e3, t3, n3, o3) {
          var r2 = o3(n3);
          null != r2 && e3.layout(r2).run();
        }, a = function(e3, t3, n3, o3) {
          var r2 = e3.style();
          null != r2 && r2.fromJson(o3(n3)).update();
        }, c = function(e3, t3, n3, o3, r2, u2, i2) {
          var l2 = [], a2 = e3.collection(), c2 = [], f = {}, d = {}, p = function(e4) {
            return r2(r2(e4, "data"), "id");
          };
          u2(n3, function(e4) {
            var t4 = p(e4);
            d[t4] = e4;
          }), null != t3 && u2(t3, function(t4) {
            var n4 = p(t4);
            f[n4] = t4, function(e4) {
              return null != d[e4];
            }(n4) || a2.merge(e3.getElementById(n4));
          }), u2(n3, function(e4) {
            var t4 = p(e4), n4 = function(e5) {
              return f[e5];
            }(t4);
            !function(e5) {
              return null != f[e5];
            }(t4) ? l2.push(o3(e4)) : c2.push({ ele1: n4, ele2: e4 });
          }), a2.length > 0 && e3.remove(a2), l2.length > 0 && e3.add(l2), c2.forEach(function(t4) {
            var n4 = t4.ele1, u3 = t4.ele2;
            return s(e3, n4, u3, o3, r2, i2);
          });
        }, s = function(e3, t3, n3, o3, r2, u2) {
          var i2 = r2(r2(n3, "data"), "id"), l2 = e3.getElementById(i2), a2 = {};
          ["data", "position", "selected", "selectable", "locked", "grabbable", "classes"].forEach(function(e4) {
            var i3 = r2(n3, e4);
            u2(i3, r2(t3, e4)) && (a2[e4] = o3(i3));
          });
          var c2 = r2(n3, "scratch");
          u2(c2, r2(t3, "scratch")) && l2.scratch(o3(c2)), Object.keys(a2).length > 0 && l2.json(a2);
        };
      }]);
    });
  }
});
export default require_react_cytoscape();
